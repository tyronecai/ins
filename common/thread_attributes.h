...
#ifndef COMMON_THREAD_ATTRIBUTES_H_
#define COMMON_THREAD_ATTRIBUTES_H_
...
class ThreadAttributes {
 public:
  ...
  int32_t GetCpuNum() { return cpu_num_; }
  ...
  void ResetCpuMask() { CPU_ZERO(&mask_); }
  void MarkCurMask() {
    CPU_ZERO(&last_mask_);
    last_mask_ = mask_;
  }
...
#endif  // COMMON_THREAD_THREAD_ATTRIBUTES_H_
