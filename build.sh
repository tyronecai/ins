...
#apt-get install libboost-dev libsnappy-dev
...
##wget -c http://d3dr9sfxru4sde.cloudfront.net/snappy-1.1.0.tar.gz
##tar zxf snappy-1.1.3.tar.gz
#cd snappy-1.1.3
#autoreconf -fvi;  ./configure --prefix=$base_dir/depends >/dev/null
#make -j4 > /dev/null
#make install
#
#cd $base_dir/thirdparty
